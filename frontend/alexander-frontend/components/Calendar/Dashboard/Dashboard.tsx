...
const Dashboard = ({ style }: DashboardProps) => {
  return (
    <section
      className={`grid-rows-autoX1 absolute bottom-0 left-sidebar_width top-header_height z-30 grid w-9/12 flex-col bg-gunmetal transition-all duration-300 ease-in-out ${style}`}
    >
