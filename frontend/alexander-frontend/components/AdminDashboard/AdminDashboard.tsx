  ...
  return (
    <>
      <section
        ...
        className={`absolute inset-0 z-30 cursor-pointer bg-dark-100 transition-all duration-200 ease-in-out hover:bg-dark-200 ${dashboardBackground}`}
      ></section>
      <section
      ...
      >
        <section className="flex flex-1 pb-12 pl-16 pr-12 pt-header_height transition-all duration-300 ease-in-out">
          <section className="border-sunset-orange grid flex-1 grid-rows-autoX1">
            <div className="flex items-center border border-dark-500 p-3">
